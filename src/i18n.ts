...
const TRANSLATIONS = {
	"zh-CN": {
		...
		"settings.scopeControlStyle.tabs": "A · 文字下划线",
		"settings.scopeControlStyle.dropdown": "B · 单入口下拉",
		"settings.scopeControlStyle.swap": "C · 状态一键交换",
		"settings.scopeControlStyle.switch": "F · 双向物理开关",
	...
	en: {
		...
		"settings.scopeControlStyle.tabs": "A · Underline tabs",
		"settings.scopeControlStyle.dropdown": "B · Single dropdown",
		"settings.scopeControlStyle.swap": "C · Status + swap",
		"settings.scopeControlStyle.switch": "F · Two-way switch",
