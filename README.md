...
- **评论与飞书同步**：侧边栏可切换当前文档和全部文档；当前文档支持编辑、回复、解决、删除、跳转回正文，并可将本地评论同步为飞书 / Lark 文档评论。
...
侧边栏标题区可切换到“全部文档”，按文件集中搜索和查看整个 Vault 的评论与标记。全部文档模式为只读；点击卡片会打开对应 Markdown 并定位原文，再切回“当前文档”处理评论或调整标记。
